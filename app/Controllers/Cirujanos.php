...
class Cirujanos extends BaseController
{
    ...
    public function crear()
    {
        ...
        if ($this->request->getMethod() === 'post' && $this->validate([
            'nombre' => [
                'label' => 'Nombre',
                'rules' => 'required|min_length[2]|max_length[100]|regex_match[/^[a-zA-ZáéíóúÁÉÍÓÚñÑüÜ\s.]+$/]',
                'errors' => [
                    'required' => 'El nombre es obligatorio',
                    'min_length' => 'El nombre debe tener al menos 2 caracteres',
                    'max_length' => 'El nombre no puede exceder 100 caracteres',
                    'regex_match' => 'El nombre solo puede contener letras, espacios, tildes y puntos'
                ]
            ],
            'dni' => [
                'label' => 'DNI',
            ...
            'disponibilidad' => [
                ...
                'rules' => 'required|in_list[disponible,no_disponible,en_cirugia,vacaciones,licencia]',
                'errors' => [
    ...
    public function validarCampo()
    {
        ...
        switch ($campo) {
            case 'nombre':
                $reglas = ['nombre' => 'required|min_length[2]|max_length[100]|regex_match[/^[a-zA-ZáéíóúÁÉÍÓÚñÑüÜ\s.]+$/]'];
                break;
            case 'dni':
