                ...
                <div class="welcome-section">
                    ...
                    <div class="data-card">
                        ...
                        <div class="data-card-body">
                            ...
                            <?php echo form_open('anestesistas/crear'); ?>
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        <label for="nombre" class="form-label">Nombre <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control <?php echo form_error('nombre') ? 'is-invalid' : ''; ?>" id="nombre" name="nombre" value="<?php echo set_value('nombre'); ?>" required>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-control <?php echo form_error('especialidad') ? 'is-invalid' : ''; ?>" id="especialidad" name="especialidad" required>
                                            ...
                                            <option value="Anestesiología Obstétrica" <?= set_select('especialidad', 'Anestesiología Obstétrica') ?>>Anestesiología Obstétrica</option>
                                            <option value="Anestesiología Regional" <?= set_select('especialidad', 'Anestesiología Regional') ?>>Anestesiología Regional</option>
                                        </select>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-control <?php echo form_error('disponibilidad') ? 'is-invalid' : ''; ?>" id="disponibilidad" name="disponibilidad" required>
                                            ...
                                            <option value="disponible" <?= set_select('disponibilidad', 'disponible') ?>>Disponible</option>
                                            <option value="no_disponible" <?= set_select('disponibilidad', 'no_disponible') ?>>No Disponible</option>
                                            <option value="en_cirugia" <?= set_select('disponibilidad', 'en_cirugia') ?>>En Cirugía</option>
                                        </select>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control <?php echo form_error('telefono') ? 'is-invalid' : ''; ?>" id="telefono" name="telefono" value="<?php echo set_value('telefono'); ?>" required>
                                ...
                                <div class="d-flex justify-content-end">
                                    ...
                                    <button type="submit" class="btn btn-primary">Crear Anestesista</button>
                                </div>
                            <?php echo form_close(); ?>
                        </div>
                    </div>
