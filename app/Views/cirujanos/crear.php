        ...
        <div class="main-content">
            ...
            <div class="dashboard-header animate-fade-in">
                ...
                <a href="<?= site_url('cirujanos') ?>" class="btn btn-secondary">
                    <i class='bx bx-arrow-back'></i> Volver a Cirujanos
                </a>
            </div>
            ...
            <div class="glass-card animate-fade-in" style="animation-delay: 0.1s">
                <div class="card-header">
                    <h5><i class='bx bx-user-plus me-2'></i>Nuevo Cirujano</h5>
                </div>
                <div class="card-body">
                    ...
                    <?= form_open('cirujanos/crear') ?>
                        ...
                        <div class="d-flex justify-content-end gap-2 mt-4">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class='bx bx-save me-1'></i>Crear Cirujano
                            </button>
                        </div>
                    <?= form_close() ?>
                </div>
