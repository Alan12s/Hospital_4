        ...
        <div class="main-content">
            ...
            <div class="glass-card animate-fade-in" style="animation-delay: 0.1s">
                <div class="card-header">
                    <h5><i class='bx bx-user-detail me-2'></i>Información del Cirujano</h5>
                </div>
                <div class="card-body">
                    <div class="detail-row">
                        <div class="detail-label">ID:</div>
                        <div class="detail-value"><?= esc($cirujano->id) ?></div>
                    </div>
                    <div class="detail-row">
                        <div class="detail-label">Nombre:</div>
                        <div class="detail-value"><?= esc($cirujano->nombre) ?></div>
                    </div>
                    <div class="detail-row">
                        <div class="detail-label">DNI:</div>
                        <div class="detail-value"><?= esc($cirujano->dni) ?></div>
                    </div>
                    <div class="detail-row">
                        <div class="detail-label">Especialidad:</div>
                        <div class="detail-value"><?= esc($cirujano->especialidad ?? 'Sin especialidad') ?></div>
                    </div>
                    <div class="detail-row">
                    ...
                    <div class="detail-row">
                        ...
                        <div class="detail-value"><?= esc($cirujano->telefono) ?></div>
                    </div>
                    <div class="detail-row">
                        <div class="detail-label">Email:</div>
                        <div class="detail-value"><?= esc($cirujano->email) ?></div>
                    </div>
                    
                    <?php if (isset($cirujano->created_at) && $cirujano->created_at): ?>
                    <div class="detail-row">
                        <div class="detail-label">Creado el:</div>
                        <div class="detail-value"><?= esc($cirujano->created_at) ?></div>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="detail-row">
                        ...
                        <div class="detail-value"><?= esc($cirujano->updated_at) ?></div>
                    </div>
                    <?php endif; ?>

                    <div class="button-group">
                        <a href="<?= site_url('cirujanos/editar/'.$cirujano->id) ?>" class="btn btn-primary">
                            <i class='bx bx-edit'></i> Editar Cirujano
                        </a>
                        <button type="button"
