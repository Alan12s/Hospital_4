        ...
        <div class="main-content">
            ...
            <div class="dashboard-header animate-fade-in">
                <div>
                    ...
                    <p class="page-subtitle">Instrumentistas actualmente disponibles para asignación</p>
                </div>
            ...
            <div class="glass-card animate-fade-in" style="animation-delay: 0.1s">
                <div class="card-header">
                    <h5><i class='bx bx-list-check me-2'></i>Listado de Instrumentistas Disponibles</h5>
                    <span class="badge bg-success"><?= count($instrumentistas) ?> disponibles</span>
                </div>
                                ...
                                <?php if (empty($instrumentistas)): ?>
                                    <tr>
                                        <td colspan="7" class="empty-state">
                                            ...
                                            <p>No hay instrumentistas disponibles actualmente</p>
                                        </td>
                                    </tr>
                                <?php else: ?>
                                    <?php foreach ($instrumentistas as $instrumentista): ?>
                                        <tr>
                                            <td><?= esc($instrumentista['nombre']) ?></td>
                                            <td><?= esc($instrumentista['dni']) ?></td>
                                            <td><?= esc($instrumentista['telefono']) ?></td>
                                            <td><?= esc($instrumentista['email']) ?></td>
                                            <td><?= esc($instrumentista['especialidad'] ?? 'Sin especialidad') ?></td>
                                            <td>
