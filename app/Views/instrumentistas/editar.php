        ...
        <div class="main-content">
            ...
            <div class="glass-card animate-fade-in" style="animation-delay: 0.1s">
                <div class="card-header">
                    <h5><i class='bx bx-edit me-2'></i>Editar Instrumentista</h5>
                </div>
                <div class="card-body">
                    ...
                    <?= form_open('instrumentistas/update/' . $instrumentista['id']) ?>
                        <?= csrf_field() ?>
                                ...
                                <select class="form-select <?= (isset($validation) && $validation->hasError('especialidad')) ? 'is-invalid' : '' ?>" 
                                    ...
                                    <?php foreach ($especialidades as $key => $especialidad): ?>
                                        <option value="<?= esc($especialidad) ?>" 
                                                <?= (old('especialidad', $instrumentista['especialidad']) == $especialidad) ? 'selected' : '' ?>>
                                            <?= esc($especialidad) ?>
                                        </option>
                                    <?php endforeach; ?>
                                </select>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="email" 
                                       ...
                                       id="email" 
                                       name="email" 
                                       value="<?= old('email', $instrumentista['email']) ?>" 
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" 
                                       ...
                                       id="fecha_ingreso" 
                                       name="fecha_ingreso" 
                                       value="<?= old('fecha_ingreso', $instrumentista['fecha_ingreso']) ?>">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select <?= (isset($validation) && $validation->hasError('disponibilidad')) ? 'is-invalid' : '' ?>" 
                                ...
                                <option value="disponible" <?= (old('disponibilidad', $instrumentista['disponibilidad']) == 'disponible') ? 'selected' : '' ?>>
                                    Disponible
                                </option>
                                <option value="no_disponible" <?= (old('disponibilidad', $instrumentista['disponibilidad']) == 'no_disponible') ? 'selected' : '' ?>>
                                    No disponible
                                </option>
                                <option value="en_cirugia" <?= (old('disponibilidad', $instrumentista['disponibilidad']) == 'en_cirugia') ? 'selected' : '' ?>>
                                    En cirugía
                                </option>
                            </select>
                        ...
                        <div class="d-flex justify-content-end gap-2 mt-4">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class='bx bx-save me-1'></i>Actualizar Instrumentista
                            </button>
                        </div>
                    <?= form_close() ?>
                </div>
