                    ...
                    <?= form_open('insumos/add') ?>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" 
                                       class="form-control <?= (isset($validation) && $validation->hasError('tipo')) ? 'is-invalid' : '' ?>" 
                                       id="tipo" 
                                       name="tipo" 
                                       value="<?= old('tipo') ?>" 
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <label for="categoria" class="form-label">
                                    <i class='bx bx-list-check'></i>Categoría
                                </label>
                            ...
                            <div class="col-md-6">
                                <label for="cantidad" class="form-label">
                                    <i class='bx bx-layer'></i>Cantidad
                                </label>
                                <input type="number" 
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <label for="codigo" class="form-label">
                                    <i class='bx bx-barcode'></i>Código
                                </label>
                                <input type="text" 
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <label for="lote" class="form-label">
                                    <i class='bx bx-package'></i>Lote (Opcional)
                                </label>
                                <input type="text" 
                                       class="form-control" 
                                       id="lote" 
                            ...
                            <div class="col-md-6">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="tiene_vencimiento">
                                        <i class='bx bx-calendar'></i>¿Tiene fecha de vencimiento?
                                    </label>
                                </div>
                                <input type="date" 
                                       class="form-control mt-2 <?= (isset($validation) && $validation->hasError('fecha_vencimiento')) ? 'is-invalid' : '' ?>" 
                                       id="fecha_vencimiento" 
                                       name="fecha_vencimiento" 
                                       value="<?= old('fecha_vencimiento') ?>" 
                                       style="<?= !old('tiene_vencimiento') ? 'display: none;' : '' ?>">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            checkVencimiento.addEventListener('change', function() {
                if(this.checked) {
                    ...
                    fechaVencimiento.setAttribute('required', '');
                } else {
