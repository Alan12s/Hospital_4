    ...
    <div class="row mb-3">
        <div class="col-md-6">
            ...
            <select class="form-select <?= isset($errors['procedimiento']) ? 'is-invalid' : '' ?>" 
                ...
                <option value="otro" <?= (old('procedimiento') == 'otro') || (session()->getFlashdata('procedimiento_data') && session()->getFlashdata('procedimiento_data')['procedimiento'] == 'otro') ? 'selected' : '' ?>>Otro (especificar)</option>
                <!-- Otras opciones de procedimiento aquí -->
            </select>
            <input type="text" class="form-control mt-2 <?= ((old('procedimiento') == 'otro') || (session()->getFlashdata('procedimiento_data') && session()->getFlashdata('procedimiento_data')['procedimiento'] == 'otro')) ? '' : 'd-none' ?> <?= isset($errors['otro_procedimiento']) ? 'is-invalid' : '' ?>" 
                   id="otro_procedimiento" name="otro_procedimiento" 
                   placeholder="Especificar otro procedimiento" 
                   value="<?= old('otro_procedimiento', session()->getFlashdata('procedimiento_data')['otro_procedimiento'] ?? '') ?>"
