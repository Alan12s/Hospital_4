...
<head>
    ...
    <title>Editar Turno Quirúrgico - Gestión Quirúrgica</title>
    <!-- Bootstrap CSS -->
    ...
    <div class="wrapper">
        ...
        <div class="main-content">
            ...
            <div class="dashboard-header animate-fade-in">
                <h1>
                    <i class='bx bx-calendar-plus'></i>Editar Turno Quirúrgico
                </h1>
            ...
            <div class="glass-card animate-fade-in" style="animation-delay: 0.1s">
                ...
                <div class="card-body">
                    <form action="<?= base_url('turnos/actualizar/' . $turno['id']) ?>" method="post">
                        <?= csrf_field() ?>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-4">
                                    ...
                                    <input type="date" class="form-control <?= isset($errors['fecha']) ? 'is-invalid' : '' ?>" 
                                           id="fecha" name="fecha" value="<?= old('fecha', $turno['fecha']) ?>" 
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="time" class="form-control <?= isset($errors['hora_inicio']) ? 'is-invalid' : '' ?>" 
                                           id="hora_inicio" name="hora_inicio" value="<?= old('hora_inicio', substr($turno['hora_inicio'], 0, 5)) ?>" 
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="number" class="form-control <?= isset($errors['duracion']) ? 'is-invalid' : '' ?>" 
                                           id="duracion" name="duracion" value="<?= old('duracion', $turno['duracion']) ?>" 
                                           min="15" max="240" step="15" required>
                                    <input type="hidden" id="hora_finalizacion" name="hora_finalizacion" value="<?= old('hora_finalizacion', $turno['hora_finalizacion']) ?>">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select <?= isset($errors['id_paciente']) ? 'is-invalid' : '' ?>" 
                                        ...
                                        <?php foreach ($pacientes as $paciente): ?>
                                            <option value="<?= $paciente->id ?>" <?= (old('id_paciente', $turno['id_paciente']) == $paciente->id) ? 'selected' : '' ?>>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select <?= isset($errors['id_quirofano']) ? 'is-invalid' : '' ?>" 
                                        ...
                                        <?php foreach ($quirofanos as $quirofano): ?>
                                            <option value="<?= $quirofano->id ?>" <?= (old('id_quirofano', $turno['id_quirofano']) == $quirofano->id) ? 'selected' : '' ?>>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select <?= isset($errors['id_cirujano']) ? 'is-invalid' : '' ?>" 
                                            ...
                                            data-old-value="<?= old('id_cirujano', $turno['id_cirujano']) ?>">
                                        ...
                                        <?php foreach ($cirujanos as $cirujano): ?>
                                            <option value="<?= $cirujano->id ?>" 
                                                    ...
                                                    <?= (old('id_cirujano', $turno['id_cirujano']) == $cirujano->id) ? 'selected' : '' ?>>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select <?= isset($errors['id_cirujano_ayudante']) ? 'is-invalid' : '' ?>" 
                                        ...
                                        <?php foreach ($cirujanos as $cirujano): ?>
                                            <option value="<?= $cirujano->id ?>" <?= (old('id_cirujano_ayudante', $turno['id_cirujano_ayudante'] ?? '')) == $cirujano->id ? 'selected' : '' ?>>
                                                <?= esc($cirujano->nombre) ?> (<?= esc($cirujano->especialidad) ?>)
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select <?= isset($errors['id_anestesista']) ? 'is-invalid' : '' ?>" 
                                        ...
                                        <?php foreach ($anestesistas as $anestesista): ?>
                                            <option value="<?= $anestesista->id ?>" <?= (old('id_anestesista', $turno['id_anestesista']) == $anestesista->id) ? 'selected' : '' ?>>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select <?= isset($errors['tipo_anestesia']) ? 'is-invalid' : '' ?>" 
                                        ...
                                        <option value="General" <?= (old('tipo_anestesia', $turno['tipo_anestesia'] ?? '') == 'General') ? 'selected' : '' ?>>General</option>
                                        <option value="Regional" <?= (old('tipo_anestesia', $turno['tipo_anestesia'] ?? '') == 'Regional') ? 'selected' : '' ?>>Regional</option>
                                        <option value="Local" <?= (old('tipo_anestesia', $turno['tipo_anestesia'] ?? '') == 'Local') ? 'selected' : '' ?>>Local</option>
                                        <option value="Sedación" <?= (old('tipo_anestesia', $turno['tipo_anestesia'] ?? '') == 'Sedación') ? 'selected' : '' ?>>Sedación</option>
                                    </select>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select <?= isset($errors['id_tecnico_anestesista']) ? 'is-invalid' : '' ?>" 
                                        ...
                                        <?php foreach ($tecnicos_anestesistas as $tecnico): ?>
                                            <option value="<?= $tecnico->id ?>" <?= (old('id_tecnico_anestesista', $turno['id_tecnico_anestesista']) == $tecnico->id) ? 'selected' : '' ?>>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select <?= isset($errors['id_instrumentador_principal']) ? 'is-invalid' : '' ?>" 
                                        ...
                                        <?php foreach ($instrumentistas as $instrumentista): ?>
                                            <option value="<?= $instrumentista->id ?>" <?= (old('id_instrumentador_principal', $turno['id_instrumentador_principal'] ?? '')) == $instrumentista->id ? 'selected' : '' ?>>
                                                <?= esc($instrumentista->nombre) ?> (<?= esc($instrumentista->especialidad ?? 'N/A') ?>)
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select <?= isset($errors['id_instrumentador_circulante']) ? 'is-invalid' : '' ?>" 
                                        ...
                                        <option value="">Seleccionar instrumentador</option>
                                        <?php foreach ($instrumentistas as $instrumentista): ?>
                                            <option value="<?= $instrumentista->id ?>" <?= (old('id_instrumentador_circulante', $turno['id_instrumentador_circulante'] ?? '')) == $instrumentista->id ? 'selected' : '' ?>>
                                                <?= esc($instrumentista->nombre) ?> (<?= esc($instrumentista->especialidad ?? 'N/A') ?>)
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select <?= isset($errors['procedimiento']) ? 'is-invalid' : '' ?>" 
                                            ...
                                            data-old-value="<?= old('procedimiento', $turno['procedimiento']) ?>">
                                        <option value="">Seleccionar procedimiento</option>
                                        <option value="otro" <?= (old('procedimiento', $turno['procedimiento']) == 'otro') ? 'selected' : '' ?>>Otro (especificar)</option>
                                    </select>
                                    <input type="text" class="form-control mt-2 <?= (old('procedimiento', $turno['procedimiento']) == 'otro') ? '' : 'd-none' ?> <?= isset($errors['otro_procedimiento']) ? 'is-invalid' : '' ?>" 
                                           id="otro_procedimiento" name="otro_procedimiento" 
                                           placeholder="Especificar otro procedimiento" value="<?= old('otro_procedimiento', $turno['procedimiento']) ?>"
                                           data-old-value="<?= old('otro_procedimiento', $turno['procedimiento']) ?>">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select <?= isset($errors['estado']) ? 'is-invalid' : '' ?>" 
                                        ...
                                        <option value="agendada" <?= (old('estado', $turno['estado']) == 'agendada') ? 'selected' : '' ?>>Agendada</option>
                                        <option value="urgencia" <?= (old('estado', $turno['estado']) == 'urgencia') ? 'selected' : '' ?>>Urgencia</option>
                                        <option value="en_proceso" <?= (old('estado', $turno['estado']) == 'en_proceso') ? 'selected' : '' ?>>En proceso</option>
                        ...
                        <div class="form-section">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <textarea class="form-control" id="observaciones" name="observaciones" rows="3"><?= old('observaciones', $turno['observaciones']) ?></textarea>
                                </div>
                                <div class="col-md-6">
                                    <label for="complicaciones" class="form-label"><i class='bx bx-error'></i>Complicaciones</label>
                                    <textarea class="form-control" id="complicaciones" name="complicaciones" rows="3"><?= old('complicaciones', $turno['complicaciones'] ?? '') ?></textarea>
                                </div>
                            </div>
                        </div>
                                                ...
                                                <table class="table table-bordered" id="tabla-insumos-seleccionados">
                                                    ...
                                                    <tbody id="insumos-seleccionados">
                                                        <?php foreach ($insumos as $insumo): ?>
                                                            <?php if (isset($insumosSeleccionados[$insumo['id_insumo']])): ?>
                                                                <tr data-insumo-id="<?= $insumo['id_insumo'] ?>">
                                                                    ...
                                                                    <td>
                                                                        <input type="hidden" name="insumos[<?= $insumo['id_insumo'] ?>]" value="<?= $insumosSeleccionados[$insumo['id_insumo']] ?>">
                                                                        <?= $insumosSeleccionados[$insumo['id_insumo']] ?>
                                                                    </td>
                                                                    <td>
                        ...
                        <div class="d-flex justify-content-end gap-2 mt-4">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class='bx bx-save me-1'></i>Actualizar Turno
                            </button>
                        </div>
                    </form>
                </div>
                                    ...
                                    <tr data-insumo-id="<?= $insumo['id_insumo'] ?>" 
                                        ...
                                        <td>
                                            <div class="form-check">
                                                <input class="form-check-input insumo-check" type="checkbox" 
                                                       ...
                                                       data-tipo="<?= esc($insumo['tipo']) ?>"
                                                       data-stock="<?= $insumo['cantidad'] ?>"
                                                       <?= (isset($insumosSeleccionados[$insumo['id_insumo']])) ? 'checked' : '' ?>>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <input type="number" class="form-control cantidad-insumo-modal" 
                                                   ...
                                                   value="<?= isset($insumosSeleccionados[$insumo['id_insumo']]) ? $insumosSeleccionados[$insumo['id_insumo']] : '1' ?>"
                                                   <?= (isset($insumosSeleccionados[$insumo['id_insumo']])) ? '' : 'disabled' ?>>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
...
$(document).ready(function() {
    ...
    // Cargar procedimientos según especialidad del cirujano seleccionado
    $('#id_cirujano').on('change', function() {
        const especialidadId = $(this).find('option:selected').data('especialidad');
        const procedimientoSelect = $('#procedimiento');
        
        if (especialidadId) {
            $.ajax({
                url: '<?= base_url('turnos/obtenerProcedimientos') ?>/' + especialidadId,
                method: 'GET',
                dataType: 'json',
                success: function(response) {
                    procedimientoSelect.empty().append('<option value="">Seleccionar procedimiento</option>');
                    
                    if (response.length > 0) {
                        response.forEach(function(proc) {
                            procedimientoSelect.append(`<option value="${proc.id}">${proc.nombre}</option>`);
                        });
                    }
                    
                    procedimientoSelect.append('<option value="otro">Otro (especificar)</option>');
                    
                    // Restaurar valor anterior si existe
                    const oldValue = procedimientoSelect.data('old-value');
                    if (oldValue) {
                        procedimientoSelect.val(oldValue);
                        
                        // Mostrar campo de otro procedimiento si es necesario
                        if (oldValue === 'otro') {
                            $('#otro_procedimiento').removeClass('d-none');
                        }
                    }
                ...
                error: function() {
                    console.error('Error al cargar procedimientos');
                }
            });
        }
    });
    ...
    // Cargar procedimientos si ya hay un cirujano seleccionado
    if ($('#id_cirujano').val()) {
        $('#id_cirujano').trigger('change');
    }
    
    // Mostrar campo de otro procedimiento si es necesario
    if ($('#procedimiento').val() === 'otro') {
        $('#otro_procedimiento').removeClass('d-none');
    }
    
    // Calcular hora de finalización al cargar la página
    calcularHoraFin();
});
    </script>
