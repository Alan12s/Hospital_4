...
--
-- Base de datos: `hospital_management`
--

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `anestesistas`
--
...
--
-- Volcado de datos para la tabla `anestesistas`
--
...
(1, 'Dr. Carlos Mendoza', '28456789', 1, '1156789236', 'c.mendoza@hospital.com', '2025-05-08 04:50:38', '2025-07-01 20:53:52', 'disponible'),
...
(29, 'Dra. Camila Vásquez', '28543210', 1, '2642678901', 'c.vasquez@hospital.com', '2025-06-30 04:25:04', '2025-07-01 20:06:04', 'disponible'),
(30, 'Dr. Martín Cordero', '34432109', 3, '2643789012', 'm.cordero@hospital.com', '2025-06-30 04:25:04', '2025-07-01 20:07:55', 'disponible');
...
--
-- Estructura de tabla para la tabla `instrumentistas`
--
...
--
-- Volcado de datos para la tabla `instrumentistas`
--
...
(9, 'INS-009', 'Bisturi', 'descartable', 'Material quirúrgico', 29, 'LOT-2025-09', '2028-06-18', 1, 'Almacen A, Estante 1'),
(11, 'INS-47BAAE', 'Cateter', 'descartable', 'Material quirúrgico', 230, 'LOTE-20250518-0011', '2027-10-18', 1, 'Almacen B, Estante 1'),
(14, 'INS-012', 'Sutura de seda 3-0', 'descartable', 'Material quirúrgico', 150, 'LOT-2025-12', '2029-03-15', 1, 'Almacén A, Estante 3'),
...
--
-- Estructura de tabla para la tabla `turnos_insumos`
--
...
--
-- Volcado de datos para la tabla `turnos_insumos`
--

INSERT INTO `turnos_insumos` (`id`, `id_turno`, `id_insumo`, `cantidad`, `fecha_registro`) VALUES
...
--
-- Estructura de tabla para la tabla `turnos_quirurgicos`
--
...
--
-- Volcado de datos para la tabla `turnos_quirurgicos`
--
...
(9, 'Lujan Ana', 'Cordoba', 'lujan@hospital.com', 'lujan', '2025-06-15 00:11:47', '2025-06-15 00:12:56', '2025-07-01 03:00:16', 'cirujano', 1, '$2y$10$t2MeMCk.xuk5soeKkQhmPulOItssxXFL0TfuQLDXK0JLxsbtGKRH6', NULL, NULL, NULL);
...
--
-- Indices de la tabla `anestesistas`
--
ALTER TABLE `anestesistas`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `cirujanos`
--
...
--
-- Indices de la tabla `instrumentistas`
--
...
--
-- Indices de la tabla `turnos_insumos`
--
...
--
-- Indices de la tabla `turnos_quirurgicos`
--
...
--
-- AUTO_INCREMENT de la tabla `anestesistas`
--
ALTER TABLE `anestesistas`
...
--
-- AUTO_INCREMENT de la tabla `instrumentistas`
--
ALTER TABLE `instrumentistas`
...
--
-- Filtros para la tabla `turnos_insumos`
--
ALTER TABLE `turnos_insumos`
...
--
-- Filtros para la tabla `turnos_quirurgicos`
--
ALTER TABLE `turnos_quirurgicos`
